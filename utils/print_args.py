def print_args(args):
    ...
    if args.task_name == 'anomaly_detection':
        ...
        print(f'  {"Mask Rate:":<20}{args.mask_rate:<20}')
        print(f'  {"Use Interpolation:":<20}{args.interpolate:<20}')
        print()
    ...
    if args.model in ['SHADE']:
        print(f'  {"Hyperedge Nums:":<20}{args.hyperedge_num:<20}{"K Hyperedge:":<20}{args.k_hyperedge:<20}')
    print()
